...
(function (WF) {
  ...
  const R = {
    ...
    hero(p, ctx, b) {
      ...
      if (variant === "split") {
        const media = p.image
          ? `<div class="b-hero__media"><img src="${esc(p.image)}" alt=""></div>`
          : `<div class="b-hero__media"><div class="wf-ph" data-label="主视觉配图"></div></div>`;
        return `<div class="b-hero__bg${bgCls}"${bg}></div>
          <div class="b-hero__inner is-split">
      ...
      if (variant === "fullscreen") {
        ...
        return `<div class="b-hero__bg is-cover" style="--wb-hero-bg:${p.image ? `url('${esc(p.image)}')` : img}"></div>
          <div class="b-hero__inner is-fullscreen">
            ${p.badge ? `<span class="b-hero__badge">${esc(p.badge)}</span>` : ""}
      ...
      return `<div class="b-hero__bg${bgCls}"${bg}></div>
        <div class="b-hero__inner${center ? " is-center" : ""}">${text}</div>`;
    },
